...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="alert alert-primary text-center shadow-sm mt-3 px-3 px-sm-5" role="alert" style="border-radius: 12px;">
                    <?php if ($tipo_usuario == 1): ?>
                        <h5 class="fw-bold mb-2">👋 ¡Hola, <?php echo $nombre; ?>!</h5>
                        <p class="mb-0">
                            Bienvenido al Sistema Web de Henry Diaz. Actualmente iniciaste sesión como
                            <strong>Administrador</strong>, lo que te otorga acceso completo a todas las funcionalidades del sistema:
                            gestión de usuarios y acceso a los proyectos.
                        </p>
                    <?php else: ?>
                        <h5 class="fw-bold mb-2">👋 ¡Hola, <?php echo $nombre; ?>!</h5>
                        <p class="mb-0">
                            Bienvenido al Sistema Web de Henry Diaz. Tu rol actual es de <strong>Usuario Estándar</strong>, por lo que tienes acceso
                            restringido a algunas funcionalidades del sistema, pero tienes acceso a: Información, Principal.
                        </p>
                    <?php endif; ?>
                </div>
